...
class WorkflowsControllerTest < ActionController::TestCase
  ...
  test "should create workflow" do
    assert_difference('Workflow.count') do
      post :create, workflow: { description: @workflow.description, name: @workflow.name, priority: @workflow.priority }
    end
  ...
  test "should update workflow" do
    patch :update, id: @workflow, workflow: { description: @workflow.description, name: @workflow.name, priority: @workflow.priority }
    assert_redirected_to workflow_path(assigns(:workflow))
  end
